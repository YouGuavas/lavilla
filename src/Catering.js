...
export default function Catering() {
  ...
  const divs = {
    1: 
    <div className="h-screen w-full bg-white bg-opacity-20 p-6 pt-40 place-items-center">
  ...
  2:
  <div className="h-screen bg-white bg-opacity-20 w-full p-6 pt-40 place-items-center">
    <div className="h-full w-full flex place-items-center justify-center">
    <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
