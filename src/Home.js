...
function Home() {
  ...
  const divs = {
    1:  <div className="h-screen w-full p-6 pt-40 place-items-center">
    ...
    2: <div className="h-screen w-full bg-white bg-opacity-20 p-6 pt-40">
    ...
    3: <div className="h-screen w-full bg-white bg-opacity-20 p-6 pt-40">
    ...
    4: <div className="h-screen w-full p-6 pt-40 bg-white bg-opacity-20">
        <div className="h-full flex place-items-center">
          <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
    ...
    5: <div className="h-screen w-full p-6 pt-40 bg-white bg-opacity-20">
        <div className="h-full flex place-items-center">
          <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
      ...
      6: 
      <div className="h-screen pt-40 w-full p-6 bg-white bg-opacity-20">
        <div className="h-full flex place-items-center">
          <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
      ...
      7:
      <div className="h-screen w-full p-6 pt-40 bg-white bg-opacity-20">
        <div className="h-full flex place-items-center">
          <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
  ...
  return(
    <div className="grid place-items-center pt-20 shadow-md bg-breadsticks bg-fixed bg-cover bg-center">
      {
      divs[divNumber]
      }
    </div>
