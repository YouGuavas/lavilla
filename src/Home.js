...
function Home() {
  ...
  const pointerStyles = "px-2 text-5xl text-red-900 transition duration-400 hover:cursor-pointer font-thin scale-y-150 hover:scale-x-110 pt-12";
  ...
  const divs = {
    ...
    3: <div className="h-screen p-6 w-full bg-white bg-opacity-20 ">
        <div className="h-full flex place-items-center">
          <div onClick={prevDiv} className={pointerStyles}>{"<"}</div>
          <div className="grid md:p-6 p-2 md:mt-20 mt-12 h-5/6 bg-white bg-opacity-70">
            <p className="font-fancy md:text-2xl text-lg font-thin text-red-900 text-center">What's for Dinner?</p>
            <p className="text-center md:text-2xl text-sm hidden md:flex font-semibold">FIND OUT AT YOUR FAVORITE MT MORRIS, MI PIZZA RESTAURANT</p>
    ...
    4: <div className="h-screen p-6 w-full bg-white bg-opacity-20">
        <div className="h-full w-full flex place-items-center">
          <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
          <div className="grid h-full w-full grid-cols-2 md:mt-24 mt-32 md:grid-rows-2">
            <div className="md:row-span-2 row-span-1 md:col-span-1 md:px-6 col-span-2 h-full grid place-items-center">
              <div className="grid grid-cols-1 md:grid-rows-3 place-items-center">
                <h2 className="font-semibold md:text-3xl text-lg py-1 md:row-span-1 col-span-1">Your local source for traditional Italian cuisine</h2>
                <p className="col-span-1 md:row-span-1 py-1 md:text-lg">Visit our reopened family restaurant in Mt. Morris, MI</p>
                <a href="/Contact Us" className="transition duration-400 md:row-span-1 md:py-6 py-2 md:h-full md:text-xl w-3/4 col-span-1 text-center bg-red-900 bg-opacity-90 border border-gray-200 text-white rounded grid place-items-center justify-center hover:scale-x-110">Contact Us</a>
              </div>
            </div>
            <div className="md:row-span-2 row-span-1 md:col-span-1 col-span-2 h-full grid grid-rows-3 gap-2 place-items-center">
              <div className="md:row-start-2 md:h-full h-1/2 row-span-1 grid">
                
                  <div onClick={() => {handleClick(6)}} className="transition duration-400 bg-green-700 hover:cursor-pointer bg-opacity-90 hover:scale-x-110 text-white md:p-6 p-3">
                    <p>Italian specialties  ⤑</p>
                    <p>Revel in our expansive menu of authentic dishes.</p>
                  </div>

                
                  <div className="transition duration-400 hover:scale-x-110 hover:cursor-pointer bg-opacity-90 md:p-6 p-3">
                    <p>Sandwiches & more  ⤑</p>
                    <p>Find what you crave.</p>
                  </div>

                <a href="/Catering">
                  <div className="transition duration-400 bg-red-900 hover:scale-x-110 bg-opacity-90 text-white md:p-6 p-3">
                    <p>Catering & events  ⤑</p>
    ...
    5: <div className="h-screen p-6 w-full bg-white bg-opacity-20">
        <div className="h-full flex place-items-center">
          <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
          <div className="grid md:grid-rows-2 md:mt-20 mt-10 h-5/6 md:gap-2 place-items-center">
            
            <div className="md:row-span-1 grid grid-cols-2 place-items-center h-full bg-white bg-opacity-70">
              <div className="md:col-span-1 col-span-2 md:text-2xl text-base md:px-6 px-2 text-red-900 font-semibold">
                Honoring the rich history of our restaurant
              </div>
              <div className="md:col-span-1 col-span-2">
                <p className="md:p-2 p-1 md:text-sm text-xs">
                ...
                <a href="/Contact Us" className="md:row-span-1 md:py-2 py-1 md:text-xl text-lg w-1/2 col-span-1 text-center md:border rounded border-red-900 bg-opacity-90 text-red-900 font-semibold grid place-items-center justify-center transition duration-400 hover:scale-x-110">
                  Visit Today!
                </a>
              </div>
            </div>

            <div className="md:row-span-1 h-full grid place-items-center grid-cols-1 bg-white bg-opacity-70">
              <h3 className="col-span-1 md:text-lg font-semibold">Stay in or dine out</h3>
              <p className="col-span-1 md:p-2 p-1 md:text-base text-sm">
      ...
      <div className="h-screen w-full p-6 bg-white bg-opacity-20">
        <div className="h-full flex place-items-center">
          <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
          <div className="md:px-20 px-4 md:mt-32 mt-12 h-5/6 w-full grid place-items-center">
            <h3 className="font-fancy font-thin text-gray-700 md:text-4xl text-xl text-center">Experience the Tastes of Italy</h3>
            <h4 className="font-semibold md:text-3xl text-lg text-red-900">Enjoy classics like pizza and pasta in Mt. Morris, MI</h4>
      ...
      <div className="h-screen w-full p-6 bg-white bg-opacity-20">
        <div className="h-full w-full flex place-items-center">
          <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
          <div className="md:px-20 px-4 md:mt-40 h-5/6 w-full grid md:grid-cols-2 place-items-center">
          ...
          <div className="md:col-span-1 col-span-2 h-full w-full place-items-center">
            <h3 className="md:text-3xl text-lg text-green-700 font-semibold py-2">
              What we offer
            </h3>
            ...
            <ul className="md:text-base text-sm md:py-2 py-1">
              <li className="md:py-1">| <span className="font-semibold">Pizza:</span> House specialties | Build-your-own | Homemade sauce</li>
              <li className="md:py-1">| <span className="font-semibold">Traditional dishes:</span> Lasagna | Spaghetti | Veal and chicken parm</li>
              <li className="md:py-1">| <span className="font-semibold">Extras:</span> Desserts | Garlic bread and breadsticks | Kid's menu</li>
            </ul>
            <p className="md:text-base text-sm">
      ...
      <div className="h-screen w-full p-6 bg-white bg-opacity-20">
        <div className="h-full w-full flex place-items-center">
          <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
          <div className="md:px-20 px-4 md:mt-32 h-5/6 w-full grid">
            <h3 className="font-fancy font-thin text-gray-700 md:text-4xl text-lg">
              Satisfy Your Lunch Cravings
            </h3>
            <h4 className="font-semibold md:text-2xl text-base text-red-900">
            ...
            <ul className='md:text-base text-xs'>
              <li className="md:py-1"><span className="font-semibold">Other entrees:</span> Fish and chips | Burgers | Reubens</li>
              <li className="md:py-1"><span className="font-semibold">Healthy choices:</span> Salads | Soups | Chili</li>
              <li className='md:py-1'><span className="font-semibold">Appetizers:</span> Cheese sticks | Fries | Wings</li>
            </ul>
            <p className='md:text-base text-sm'>
      ...
      <div className="h-screen w-full p-6 bg-white bg-opacity-20">
        <div className="h-full flex place-items-center">
          <div className={pointerStyles} onClick={prevDiv}>{"<"}</div>
          <div className="md:px-20 px-4 md:mt-32 md:h-full h-5/6 w-full grid md:gap-4 grid-cols-2 place-items-center">
  ...
  return(
    <div className="h-full grid place-items-center pt-20 shadow-md bg-breadsticks bg-fixed bg-cover bg-center">
      {
      divs[divNumber]
      }
    </div>
